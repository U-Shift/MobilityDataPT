...
#' Queries IP API to calculate expected toll costs across vehicle classes (C1, C2, C3, C4)
#' for a given spatial itinerary.
#'
#' @note Data source: Infraestruturas de Portugal (\url{https://portagens.infraestruturasdeportugal.pt/}). Terms of service apply.
